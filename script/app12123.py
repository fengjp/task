...
def run():
    while 1:
      ...
      sql_str = "select id,remarks,longtime from  meter where totitle='app12123'  and today = " + set_day  + " and times = " + set_seconds
      ...
      if len(meter_date):
          ...
          sql_str2 = 'insert into meter(totitle,today,times,longtime,remarks,create_time)  values("app12123",'  + set_day + ','\
